...
Algorithms used:
    - Capacity Fade: Know current and max capacity                                      --Uddin et al 2017
    - Capacity Fade: Know MIN_SOC, tempurature, and ampere hours                        --Cordoba-Arenas et al. 2015
    - Power Fade: Know current and max power fade                                       --Uddin et al 2017
    - Power Fade: Know MIN_SOC, tempurature, and ampere hours                           --Cordoba-Arenas et al. 2015
    - conversion to cost: max[CF x $_batt, PF x $_batt]                                 --Uddin et al 2017
    - Battery Management System (BMS)                                                   --Uddin et al 2017
*/

/**
 * compares PF and CF battery degradation and converts the worse of the 2's degradation into a monetary value
 * 
 ...
 */
function calc_cf_with_current_cap(cell_cap, max_rated_cell_cap, CF_factor = .8) {
 ...
 */
 function calc_cf_cycle_aging_with_SOC_and_temp(SOC_min, Ah, tempurature, time_cd = 1, time_cs = 0) { // Used by <fleet-capacity,js>
    //constants
    var a_c = 137,
        B_c = 420,
        y_c = 9610,
 ...
 function get_ampHr(milesDrivenPerYr, kWhPerMile, voltOfChargingStation = 120) { // Used by <fleet-capacity,js>
 ...
 * @returns power fade
 */
function calc_pf_with_current_res(internal_res, charge_transfer_res, init_internal_res, init_charge_transfer_res, PF_factor) {
