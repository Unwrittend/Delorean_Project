...
var vehicle_type = "Nissan Leaf", msoc = .5, opt_in = .5, battery_capacity = 100, zip_code = 95050,
	veh_pop, flt_cap, summer_rev, winter_rev;
...
$("#optinText, #optinSlider").change(function(){
	...
	calc_veh_pop();
	calc_flt_cap();
	winter_rev = calc_revenue_pge_tou("Winter", 15);
	summer_rev = calc_revenue_pge_tou("Summer", 15);
	console.log(summer_rev);
	console.log(winter_rev);
	console.log(veh_pop);
